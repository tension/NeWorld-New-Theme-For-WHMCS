...
$_LANG['affiliatestitle'] = "推广联盟";
$_LANG['affiliatesvisitorsreferred'] = "推荐的访问数量";
$_LANG['affiliateswithdrawalrequestsuccessful'] = "您的提现请求已经提交，我们会尽快联系您。";
$_LANG['affiliateswithdrawn'] = "已提现的佣金";
$_LANG['all'] = "共";
...
$_LANG['clientareacancelconfirmation'] = "您的取消请求已经被提交。如果您的这个请求是错误的，请立刻提交工单通知我们，否则您的账号可能会被删除。";
$_LANG['clientareacancelinvalid'] = "此账号已经提交了一个取消请求，所以无法提交另一个取消请求。";
...
$_LANG['clientareaerrorbannedemail'] = "我们不允许您使用提供的邮件地址，请用其它的邮件地址再试一次。";
...
$_LANG['clientareaerrorpasswordconfirm'] = "您没有您的确认密码";
...
$_LANG['clientareahostingnextduedate'] = "下次付款";
...
$_LANG['creditcardconfirmation'] = "您的新的信用卡信息被接受并且您账号的首次付款已经完成。已发送给您一封确认邮件。";
...
$_LANG['domainsautorenewdisabledwarning'] = "警告！该域名已关闭自动续费。<br />除非手动续费，否则域名将在到期后失效。";
...
$_LANG['invoiceofflinepaid'] = "离线信用卡支付被手工处理。<br />当您的支付请求处理完毕后您将会收到一封确认电子邮件。";
...
$_LANG['kbsuggestionsexplanation'] = "下列常见问题中的文章可能会解决您的问题。请查看后再提交。";
$_LANG['knowledgebasearticles'] = "文章";
$_LANG['knowledgebasecategories'] = "分类";
$_LANG['nokbcategories'] = "分类不存在";
$_LANG['knowledgebasedescription'] = "浏览常见问题来寻找常见问题的解答";
...
$_LANG['loginintrotext'] = "您必须先登录才可以访问此页面。注意：用户中心的账户和密码与空间控制面板的用户名和密码不同。";
...
$_LANG['networkissuesprioritycritical'] = "紧急";
...
$_LANG['ordernewuser'] = "我是新的用户，我想建立一个新的账号";
...
$_LANG['rssfeed'] = "订阅";
$_LANG['securityanswerrequired'] = "您必需输入一个安全答案";
...
$_LANG['supportticketsheader'] = "您可以在此提交您遇到的问题，客服人员在收到后会尽快回答。<br><br><b>使用说明：</b><ol style='list-style-type: decimal;padding-left: 30px;'><li>请先阅读常见问题，并合理使用搜索引擎，您的问题也许很普遍，已经在网上被回答了很多次，直接找到答案会更加节省您的时间。</li><li>请选择正确的部门提交您的问题，每个部门所处理的具体事项在部门名称后有具体说明。</li><li>各部门的工作时间为每天 9:00-18:00。</li></ol><br><br><b>服务承诺：</b><br>您在工作时间内提交的问题，将在 6 小时内答复，24 小时内解决。非工作时间提交的问题，由值班人员尽快答复。<br><br><b>请在此选择受理您提问的部门：</b><br><br><br>";
...
$_LANG['supportticketclosedmsg'] = "工单已关闭。您可以重新回复此工单来开启它";
...
$_LANG['pwresetvalidationsent'] = "邮件发送成功";
$_LANG['pwresetvalidationcheckemail'] = "正在重置密码。下一步请检查您的邮件里面关于如何重置的说明。";
...
$_LANG['affiliatescommissionspending'] = "确认中的佣金";
$_LANG['affiliatescommissionsavailable'] = "有效的佣金";
...
# Version 4.2
$_LANG['promoappliedbutnodiscount'] = "购物车中没有产品适用于此优惠码。";
...
$_LANG['subaccountpermsaffiliates'] = "查看并管理联盟账户";
...
$_LANG['domainrenewalsnoneavailable'] = "有任何域名更新，在您的账户";
...
$_LANG['noquotes'] = "目前您的账户没报价单。<br />需要请求报价，请提交工单。";
...
$_LANG['invoicepaymentpendingreview'] = "您的付款已经成功，我们会尽快的审核然后自动应用到您的订单，2CheckOut 检查已完成。";
$_LANG['step'] = "步骤 %s";
...
$_LANG['cartproductchooseoptions'] = "产品配置";
$_LANG['cartproductselection'] = "选购产品";
$_LANG['cartreviewcheckout'] = "确认结账";
...
$_LANG['domaincannotbemanaged'] = "不能自动管理 - 请联络有关的任何更改您想的支持";
$_LANG['domainbulkmanagementnotpossible'] = "不幸的是，这些设置不能在当前的时间，从我们的用户中心的编辑，请联系支持您想做出任何更改。";
...
$_LANG['domainreglockinfo'] = "域名锁定（又称防盗保护）保护您的域名在未经授权的情况下不被转移。";
$_LANG['domainreglockrecommend'] = "我们建议您开启防盗功能来保护域名，除非需要转移域名时关闭域名锁定。";
...
$_LANG['captchaverify'] = "请输入您在以下图片中看到的字符，该验证用于防止恶意注册。";
...
# Product Bundles
$_LANG['bundledeal'] = "绑定优惠！";
$_LANG['bundlevaliddateserror'] = "绑定不可用";
$_LANG['bundlevaliddateserrordesc'] = "此绑定未激活或已过期。如果您觉得信息有错误，请联系技术支持。";
$_LANG['bundlemaxusesreached'] = "绑定不可用";
$_LANG['bundlemaxusesreacheddesc'] = "此捆绑优惠已达到允许的最大用户数量，所以很遗憾不可以用了。如果您对我们的服务感兴趣您可以联系我们与我们商谈。";
$_LANG['bundlereqsnotmet'] = "绑定请求不符合";
$_LANG['bundlewarningpromo'] = "所选的绑定不可以与其他任何促销或优惠同时使用";
...
$_LANG['navservicesplaceorder'] = "订购新服务";
...
$_LANG['clientareahomeorder'] = "查看可购买的产品与服务，已注册用户也可以购买产品与增值服务。";
...
$_LANG['clientareaproductdetailsintro'] = "下面是您的产品/服务摘要";
...
$_LANG['availcreditbaldesc'] = "您的账户余额还有 %s 可自动用于新账单上";
...
$_LANG['pwstrengthweak'] = "较弱（请务必使用复杂密码以提高安全性）";
$_LANG['pwstrengthmoderate'] = "一般（请使用复杂密码以提高安全性）";
...
$_LANG['domaininfoexp'] = "您可以在右边查看您的域名详细信息，您可以点击上方的标签管理您的域名。";
$_LANG['domainrenewexp'] = "开启自动续费,在域名到期前会生成订单给您，避免域名被抢注。";
$_LANG['domainnsexp'] = "在 DNS 服务器中保留有该域名的 DNS 记录，比如 A 记录，MX 记录等修改 DNS 服务器一般在 24 小时内生效。";
...
$_LANG['addfundsdescription'] = "充值金额至账户后，可用于自动支付您的订单。";
$_LANG['addfundsnonrefundable'] = "* 账户金额不可用于提现。";
$_LANG['creditcardexpirydateinvalid'] = "到期日必须为格式 MM/YY，不能为过去的时间";
...
$_LANG['downloadproductrequired'] = "下载此项目需要您有下列激活的产品/服务实例：";
$_LANG['affiliatesignuptitle'] = "每次介绍客户给我们，均可索取报酬";
$_LANG['affiliatesignupintro'] = "激活您的联盟账户，并开始获取收益…";
$_LANG['affiliatesignupinfo1'] = "每个通过您的链接购买的服务，我们都将支付佣金给您。";
$_LANG['affiliatesignupinfo2'] = "我们跟踪您的访客是指使用 Cookie，所以就算您的用户没有立即购买，您也会在他购买后收到佣金。Cookie 有效期为 90 天。";
...
# Version 5.2
$_LANG['yourclientareahostingaddons'] = "本产品具有以下插件。";
$_LANG['loginrequired'] = "需要登录";
$_LANG['unsubscribe'] = "退订";
$_LANG['emailoptout'] = "退订电子报";
$_LANG['newsletterunsubscribe'] = "退订电子报";
$_LANG['emailoptoutdesc'] = "勾选退订我们的电子报";
$_LANG['alreadyunsubscribed'] = "您已经取消订阅我们的电子报。";
$_LANG['newsletterresubscribe'] = "如果您想重新订阅，您可以在任何时间在用户中心通过 %s我的详细信息%s 来订阅。";
$_LANG['unsubscribehashinvalid'] = "退订失败，请联系技术支持。";
$_LANG['unsubscribesuccess'] = "退订成功";
$_LANG['newsletterremoved'] = "谢谢您，您的邮箱现在已经从我们的发件列表中删除。";
...
$_LANG['feedbacksupplyrating'] = "请为 :staffname 至少打 1 分（评论是可选的）";
$_LANG['returnclient'] = "返回用户中心";
$_LANG['clientareanavsecurity'] = "安全设置";
$_LANG['twofactorauth'] = "双重验证";
$_LANG['twofaenable'] = "启用双重验证";
$_LANG['twofadisable'] = "关闭双重验证";
$_LANG['twofaenableclickhere'] = "点击这里启用";
$_LANG['twofadisableclickhere'] = "点击这里禁用";
$_LANG['twofaenforced'] = "为了您的安全，我们需要您必须启用双重验证才可以继续。此页面将会引导您完成设置双重验证的步骤。";
$_LANG['twofasetup'] = "双重验证设置过程";
$_LANG['twofasetupgetstarted'] = "开始";
$_LANG['twofaactivationintro'] = "双重验证为登录提供了额外的一层保护。一旦启用并配置，每次当您登录时都被要求输入您的用户名和密码以及双重验证代码，例如安全码。";
$_LANG['twofaactivationmultichoice'] = "若要继续，请从下面选择您想要的双重验证方式。";
$_LANG['twofadisableintro'] = "要禁用双重验证，请在下面的字段中输入您的密码。";
$_LANG['twofaactivationerror'] = "尝试为您的账户激活双重验证时发生错误，请再试一次。";
$_LANG['twofamoduleerror'] = "加载模块时发生错误。请再试一次。";
$_LANG['twofaactivationcomplete'] = "双重验证设置完成！";
$_LANG['twofadisableconfirmation'] = "您的账户目前已禁用双重验证。";
$_LANG['twofabackupcodeis'] = "您的备份代码";
$_LANG['twofanewbackupcodeis'] = "您的新备份代码为";
$_LANG['twofabackupcodelogin'] = "输入上述您的备份代码登录";
$_LANG['twofabackupcodeexpl'] = "在纸上写下来并妥善保管。<br/>如果您的双重验证设备丢失或无法使用时需要用到。";
$_LANG['twofaconfirmpw'] = "输入您的密码";
$_LANG['twofa2ndfactorreq'] = "您需要输入双重验证代码来完成登录";
$_LANG['twofa2ndfactorincorrect'] = "您提供的双重验证不正确。请再试一次。";
$_LANG['twofabackupcodereset'] = "通过备份码登录成功<br />备份码只可使用一次，现在即将重置。";
$_LANG['twofacantaccess2ndfactor'] = "无法访问您的双重验证设备？";
...
$_LANG['twoipverificationstepmsg'] = "请输入您的移动认证应用生成的安全代码，我们将确保它在启用前配置正确。";
$_LANG['twoipverificationerror'] = "貌似出了点问题…";
$_LANG['twoipcodemissmatch'] = "您输入的代码不匹配逾期，请重试。";
$_LANG['twoiptimebasedpassword'] = "基于时间的一次性密码";
$_LANG['twoiptimebasedexplain'] = "此二次验证使用了基于时间的算法获取它的二次验证。您的手机可用于生成验证码。如果您没有安装此类软件，我们推荐您使用 Google Authenticator，可适用于 iOS、Android 和 Windows 移动设备。";
$_LANG['twoipconfigureapp'] = "配置您的认证应用：";
$_LANG['twoipconfigurestep1'] = "通过选择添加一个基于时间的令牌来开始";
$_LANG['twoipconfigurestep2'] = "然后使用您的应用扫描下面的二维码，或可手动选择输入此密钥：";
...
$_LANG['domaincontactdetails']['Email'] = "邮箱";
$_LANG['domaincontactdetails']['Email Address'] = "邮箱地址";
...
$_LANG['enomfrregistration']['EU Non-French Individuals']['Name'] = "欧盟非法国的个人";
...
$_LANG['aboutsecurityquestions'] = "为什么设置安全问题？";
$_LANG['registersecurityquestionblurb'] = "设置安全问题将获得更高的安全性，因为账户的更改会用到它。";
$_LANG['update'] = "更新";
$_LANG['yourinfo'] = "您的信息";
...
$_LANG['pwresetemailneeded'] = "密码忘记？请在下面填写您的邮件地址。";
...
$_LANG['domainsExpiringInMoreThan180Days'] = "在 180+ 天内到期";
...
$_LANG['quoteacceptcontractwarning'] = "请注意，接受报价单认为是签订了一个合同，您一旦接受无法取消。";
// Client alerts
...
$_LANG['licensingaddon']['reissue'] = "释放许可";
...
$_LANG['clientAreaSecurityTwoFactorAuthRecommendation'] = "我们强烈建议您启用二次验证来增加安全性";
$_LANG['clientAreaSecurityNoSecurityQuestions'] = "设置安全问题和答案可以帮助保护您的账户防止未经授权的密码重置，并且当请求更改时帐户时允许我们验证您的身份。";
$_LANG['clientAreaSecuritySecurityQuestionOtherError'] = "安全问题和答案可以帮助保护您的账户防止未经授权的密码重置，并且当请求更改时帐户时允许我们验证您的身份。";
...
$_LANG['orderForm']['streetAddress'] = "联系地址";
$_LANG['orderForm']['streetAddress2'] = "联系地址（第二行）";
...
$_LANG['orderForm']['accountSecurity'] = "账号安全";
...
$_LANG['orderForm']['promotionAccepted'] = "优惠码验证通过，";
...
$_LANG['domainChecker.additionalPricingOptions'] = '附加价格选项：域名';
...
$_LANG['sso']['disablenotice'] = "您可能希望禁用此功能，如果您不希望您提供访问用户权限的任何第三方应用程序能够访问您的付款帐户。";
$_LANG['sso']['enabled'] = "您的账户当前已允许单点登录。";
$_LANG['sso']['disabled'] = "您的账户当前已禁用单点登录。";
$_LANG['sso']['redirectafterlogin'] = "您将会在登录后重定向";
$_LANG['oauth']['badTwoFactorAuthModule'] = "二次验证模块损坏。请联系技术支持。";
$_LANG['oauth']['permAccessNameAndEmail'] = "访问您的姓名和邮件地址";
$_LANG['errorButTryAgain'] = "发生错误。请重试。";
$_LANG['emailSent'] = '邮件发送';
$_LANG['verificationKeyExpired'] = '邮件验证密钥已过期。请登录并重新发送。';
$_LANG['emailAddressVerified'] = '感谢您确认您的邮件地址。';
$_LANG['emailKeyExpired'] = '邮件验证密钥已过期。请重新发送。';
$_LANG['verifyEmailAddress'] = '请检查您的邮件并打开里面的链接验证您的邮件地址。';
$_LANG['resendEmail'] = '重新发送验证邮件';
...
$_LANG['orderForm']['packagesForBudget'] = "我们设计了多种套餐以应对各种预算";
$_LANG['orderForm']['exploreNow'] = "现在浏览套餐包";
$_LANG['orderForm']['transferToUs'] = "转移域名到我们这";
$_LANG['orderForm']['transferExtend'] = "现在转移延迟您 1 年的使用期！";
...
$_LANG['clientareatransferredaway'] = "转移了";
$_LANG['clientareacompleted'] = "完成";
$_LANG['domainContactUs'] = "联系我们";

$_LANG['orderForm']['shortPerYear'] = "/ 年";
$_LANG['orderForm']['shortPerYears'] = "/ 年";

$_LANG['domainCheckerSalesGroup']['sale'] = "出售";
$_LANG['domainCheckerSalesGroup']['hot'] = "热销";
$_LANG['domainCheckerSalesGroup']['new'] = "新款";

$_LANG['pricing']['browseExtByCategory'] = "按类别浏览扩展";
$_LANG['pricing']['register'] = "新价格";
$_LANG['pricing']['transfer'] = "转入";
...
$_LANG['navWebsiteSecurity'] = "网站 & 安全";
$_LANG['navMarketConnectService']['symantec'] = "SSL 安全证书";
$_LANG['navMarketConnectService']['weebly'] = "网站建设";
$_LANG['navMarketConnectService']['spamexperts'] = "E-mail 服务";

$_LANG['store']['emailServices']['title'] = "E-mail 服务";
$_LANG['store']['ssl']['title'] = "SSL 安全证书";
$_LANG['store']['ssl']['dv']['title'] = "域名验证 SSL";
$_LANG['store']['ssl']['ov']['title'] = "组织验证 SSL";
$_LANG['store']['ssl']['ev']['title'] = "扩展验证 SSL";
$_LANG['store']['ssl']['wildcard']['title'] = "通配符 SSL";
$_LANG['store']['websiteBuilder']['title'] = "网站建设";
...
$_LANG['invoicesPaymentPending'] = "等待付款";
...
$_LANG['errorPage']['404']['title'] = "找不到页面!";
$_LANG['errorPage']['404']['subtitle'] = "这是一个错误的地址，貌似我们并没有这个页面！";
$_LANG['errorPage']['404']['description'] = "请尝试使用下面的导航。";
$_LANG['errorPage']['404']['home'] = "返回首页";
$_LANG['errorPage']['404']['submitTicket'] = "技术支持";
...
$_LANG['cart']['availableCreditBalance'] = "你可用余额为 :amount.";
$_LANG['cart']['applyCreditAmount'] = "使用余额 <span>:amount</span> 支付此订单，通过下列支付方式支付剩余金额。";
$_LANG['cart']['applyCreditAmountNoFurtherPayment'] = "使用余额 <span>:amount</span> 支付此订单。";
$_LANG['cart']['applyCreditSkip'] = "不使用余额支付，我将使用下面的支付方式付款。";
