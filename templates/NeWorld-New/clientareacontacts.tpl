	            ...
	            <fieldset class="form-horizontal">
	                <div id="newPassword1" class="form-group has-feedback">
	                    ...
	                    <div class="col-sm-6">
	                        ...
	                        <span class="form-control-feedback glyphicon" style="right: 20px;"></span>
