...
<form role="form" method="post" action="{$smarty.server.PHP_SELF}?action=addcontact">
	...
	<span class="c-divider has-text c-divider--small u-mv-medium">{$LANG.orderForm.billingAddress}</span>
    ...
    <div class="row">
	    ...
	    <div class="form-group col-sm-12">
		    ...
		    <div id="subacct-container" class="well{if !$subaccount} hidden{/if}">
		        ...
		        <div class="form-group col-12">
		            ...
		            <div class="checkbox clearfix row">
	    ...
	    <div class="form-group col-sm-12">
	        <h3 class="u-h6">{$LANG.clientareacontactsemails}</h3>
	        <div class="controls checkbox">
	            <label>
